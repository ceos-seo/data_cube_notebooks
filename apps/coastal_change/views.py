...
def coastal_change(request, area_id):
    ...
    **Template**
    ...
    context = {
        ...
        'info_panel': 'map_tool/coastal_change/info_panel.html',
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            create_coastal_change.delay(query_id, user_id)
...
def get_query_history(request, area_id):
    ...
    **Template**
    ...
    return render(request, 'map_tool/coastal_change/query_history.html', context)
...
def get_output_list(request, area_id):
    """
    Loads the output of the given query for a requested ID.AreaExtent
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        return render(request, 'map_tool/coastal_change/output_list.html', context)
    return HttpResponse("Invalid Request.")
