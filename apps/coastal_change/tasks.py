...
@task(name="coastal_change.parse_parameters_from_task")
...
@task(name="coastal_change.validate_parameters")
...
@task(name="coastal_change.processing_task", acks_late=True)
...
@task(name="coastal_change.recombine_geographic_chunks")
...
@task(name="coastal_change.recombine_time_chunks")
...
@task(name="coastal_change.create_output_products")
