    ...
    **Template**
    ...
    for satellite in satellites:
        forms[satellite.satellite_id] = {
            'Data Selection': DataSelectForm(auto_id=satellite.satellite_id + "_%s"),
    ...
    context = {
        'tool_name': 'slip',
        'info_panel': 'map_tool/slip/info_panel.html',
...
def get_query_history(request, area_id):
    ...
    **Template**
    ...
    return render(request, 'map_tool/slip/query_history.html', context)
...
def get_results_list(request, area_id):
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        return render(request, 'map_tool/slip/results_list.html', context)
...
def get_output_list(request, area_id):
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        return render(request, 'map_tool/slip/output_list.html', context)
    return HttpResponse("Invalid Request.")
