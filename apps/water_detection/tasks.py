...
@task(name="water_detection.parse_parameters_from_task")
...
@task(name="water_detection.validate_parameters")
...
@task(name="water_detection.perform_task_chunking")
...
@task(name="water_detection.start_chunk_processing")
...
@task(name="water_detection.processing_task", acks_late=True)
    ...
    **params is updated with time and geographic ranges then used to load data.
    ...
    for time_index, time in enumerate(times):
        ...
        if task.animated_product.animation_id != "none":
            ...
            animated_data = wofs_data.isel(time=0, drop=True) if task.animated_product.animation_id == "scene" else water_analysis
...
@task(name="water_detection.recombine_geographic_chunks")
...
@task(name="water_detection.recombine_time_chunks")
...
@task(name="water_detection.create_output_products")
