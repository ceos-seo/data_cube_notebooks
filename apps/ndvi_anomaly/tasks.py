...
@task(name="ndvi_anomaly.parse_parameters_from_task")
...
@task(name="ndvi_anomaly.validate_parameters")
...
@task(name="ndvi_anomaly.perform_task_chunking")
...
@task(name="ndvi_anomaly.start_chunk_processing")
...
@task(name="ndvi_anomaly.processing_task", acks_late=True)
...
@task(name="ndvi_anomaly.recombine_geographic_chunks")
...
@task(name="ndvi_anomaly.create_output_products")
