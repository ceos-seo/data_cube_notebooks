...
@task(name="urbanization.parse_parameters_from_task", base=BaseTask)
...
@task(name="urbanization.validate_parameters", base=BaseTask)
...
@task(name="urbanization.perform_task_chunking", base=BaseTask)
...
@task(name="urbanization.start_chunk_processing", base=BaseTask)
...
@task(name="urbanization.processing_task", acks_late=True, base=BaseTask)
...
@task(name="urbanization.recombine_time_chunks", base=BaseTask)
...
@task(name="urbanization.process_band_math", base=BaseTask)
...
@task(name="urbanization.recombine_geographic_chunks", base=BaseTask)
...
@task(name="urbanization.create_output_products", base=BaseTask)
