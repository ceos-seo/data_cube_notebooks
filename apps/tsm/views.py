...
def tsm(request, area_id):
    ...
    **Template**
    ...
    app = Application.objects.get(application_id="tsm")
    ...
    context = {
        'tool_name': 'tsm',
        'info_panel': 'map_tool/tsm/info_panel.html',
...
def get_query_history(request, area_id):
    ...
    **Template**
    ...
    return render(request, 'map_tool/tsm/query_history.html', context)
...
def get_results_list(request, area_id):
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        return render(request, 'map_tool/tsm/results_list.html', context)
...
def get_output_list(request, area_id):
    ...
    **Template**
    ...
    if request.method == 'POST':
        ...
        return render(request, 'map_tool/tsm/output_list.html', context)
    return HttpResponse("Invalid Request.")
