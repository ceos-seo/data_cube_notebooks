...
@task(name="tsm.parse_parameters_from_task")
...
@task(name="tsm.validate_parameters")
...
@task(name="tsm.perform_task_chunking")
...
@task(name="tsm.start_chunk_processing")
...
@task(name="tsm.processing_task", acks_late=True)
...
@task(name="tsm.recombine_geographic_chunks")
...
@task(name="tsm.recombine_time_chunks")
...
@task(name="tsm.create_output_products")
