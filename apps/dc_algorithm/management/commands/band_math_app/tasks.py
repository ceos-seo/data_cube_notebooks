...
@task(name="band_math_app.parse_parameters_from_task")
...
@task(name="band_math_app.validate_parameters")
...
@task(name="band_math_app.perform_task_chunking")
...
@task(name="band_math_app.start_chunk_processing")
...
@task(name="band_math_app.recombine_time_chunks")
...
@task(name="band_math_app.recombine_geographic_chunks")
...
@task(name="band_math_app.process_band_math")
...
@task(name="band_math_app.create_output_products")
